...
@Configuration
@MapperScan(value = "com.airguard.mapper.main", sqlSessionFactoryRef = "sqlSessionFactory")
public class MainDatabaseConfig {
  ...
  public SqlSessionFactory sqlSessionFactoryBean(
    ...
    factoryBean
        .setMapperLocations(applicationContext.getResources("classpath:mybatis/mapper/main/*.xml"));
