...
<script src="/resources/share/js/system/oaqFota.js"></script>
<!-- ##### Header Area End ##### -->
		...
		<div class="modal-dialog modal-lg" style="max-width: 40%;">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title"><strong>OAQ Firmware Update</strong></h4>
							...
							<div class="row">
								...
								<div class="col-6" style="margin-top: 65px;">
									...
									<!--  <select name="firmwareList" id="firmwareList" style="width:180px;height:45px;">
										<option value="OAQ_TEST_FW_V1.bin">OAQ_TEST_FW_V1.bin</option>
									</select>-->
