...
<script src="/resources/share/js/system/iaqFota.js"></script>
<!-- ##### Header Area End ##### -->
			...
			<div class="col-12">
				<div class="card">
					...
					<div class="card-body">
						...
						<table id="iaqTable" class="table table-bordered table-hover">
							 <thead>
                                <tr>
		...
		<div class="modal-dialog modal-lg" style="max-width: 40%;">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title"><strong>IAQ Firmware Update</strong></h4>
							...
							<div class="row">
								...
								<div class="col-6" style="margin-top: 65px;">
									...
									<!-- <select name="firmwareList" id="firmwareList" style="width:180px;height:45px;">
										<option value="IAQ_TEST_FW_V1.bin">IAQ_TEST_FW_V1.bin</option>
									</select>-->
