...
<script src="/resources/share/js/region/airKorList.js"></script>
<!-- ##### Footer Area End ##### -->
			...
			<div class="col-12">
				<div class="card">
					...
					<div class="card-body">
						<div class="search_area" style="width:90%">
							<div class="search_bottom mt10" style="max-width:610px;">								
								<select name="searchType" id="searchType" class="custom-select custom-select-sm form-control form-control-sm mr10" style="max-width:100px;height:38px;">
									...
									<option value ="sch_air_code">에어코리아 코드</option>
									<option value ="sch_air_name">스테이션 명</option>
									<option value ="sch_air_city">도시 명</option>
									<option value ="sch_dcode">행정동 코드</option>
									<option value ="sch_air_addr">도시 주소</option>
								</select>
						...
						<table id="airKorTable" class="table table-bordered table-hover text-center">
							 <thead>
                                <tr>
                                    <th class="bgGray1">번호</th>
                                    <th class="bgGray1">에어코리아 코드</th>
                                    <th class="bgGray1">스테이션 명</th>
                                    <th class="bgGray1">도시 명</th>
                                    <th class="bgGray1">행정동 코드</th>
                                    <th class="bgGray1">도시 주소</th>
...
<input type="hidden" name="aAirCode" id="aAirCode"/>
<input type="hidden" name="aAirName" id="aAirName"/>
