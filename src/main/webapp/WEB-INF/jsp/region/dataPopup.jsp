...
<script src="/resources/share/js/region/dataPopup.js"></script>
						...
						<div class="card-body">
							...
							<div class="form-group mt20">
								...
								<div id="chartTypes" style="display: inline-block; float: right;">
									<label style='padding-right: 10px'><input type='checkbox' name='chartType' value='pm10'>미세먼지</label>
									<label style='padding-right: 10px'><input type='checkbox' name='chartType' value='pm10_raw'>미세먼지(원본)</label>
									<label style='padding-right: 10px'><input type='checkbox' name='chartType' value='pm10_ratio'>미세먼지(보정비율)</label>
									<label style='padding-right: 10px'><input type='checkbox' name='chartType' value='pm10_offset'>미세먼지(보정옵셋)</label>
									<label style='padding-right: 10px'><input type='checkbox' name='chartType' value='pm25'>초미세먼지</label>
									<label style='padding-right: 10px'><input type='checkbox' name='chartType' value='pm25_raw'>초미세먼지(원본)</label>
									<label style='padding-right: 10px'><input type='checkbox' name='chartType' value='pm25_ratio'>초미세먼지(보정비율)</label>
									<label style='padding-right: 10px'><input type='checkbox' name='chartType' value='pm25_offset'>초미세먼지(보정옵셋)</label>
								</div>
							</div>
