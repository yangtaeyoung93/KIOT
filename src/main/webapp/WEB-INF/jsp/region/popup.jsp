...
var dfname = '<%=request.getParameter("dfname")%>';
var lat = '<%=request.getParameter("lat")%>';
var lon = '<%=request.getParameter("lon")%>';
</script>

<script src="/resources/share/js/region/popup.js"></script>
			...
			<div class="card">
					<form role="form">
						<div class="card-body">
							...
							<input type="hidden" id="p_h_dcode"/>
							<input type="hidden" id="p_h_dfname"/>
							...
							<div class="row" style="border-top:3px solid #aaa; height:35px; line-height:35px;">
								<div class="col-2" style="background-color:#e6edf9; border-bottom:1px solid #aaa;">행정동코드</div>
								<div class="col-4" id="txtDcode" style="border-bottom:1px solid #aaa;"></div>
								<div class="col-2" style="background-color:#e6edf9; border-bottom:1px solid #aaa;">행정동명</div>
								<div class="col-4" id="txtDfname" style="border-bottom:1px solid #aaa;"></div>
							</div>
...
<%--								<select style="min-width:130px; height:38px; float: right;" id="chartTypeSelect">--%>
