...
<head>
    ...
    <script src="/resources/share/js/collection/vent_popup.js"></script>
<body>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mt20">
                                ...
                                <div id="chartTypes" style="display: inline-block; float: right;">
                                    <label style='padding-right: 10px'><input type='checkbox'
                                                                              name='chartType'
                                                                              value='power'>전원</label>
                                    <label style='padding-right: 10px'><input type='checkbox'
                                                                              name='chartType'
                                                                              value='air_volume'>풍량</label>
                                    <label style='padding-right: 10px'><input type='checkbox'
                                                                              name='chartType'
                                                                              value='exh_mode'>배기모드</label>
                                    <label style='padding-right: 10px'><input type='checkbox'
                                                                              name='chartType'
                                                                              value='filter_alarm'>필터알림</label>
                                    <label style='padding-right: 10px'><input type='checkbox'
                                                                              name='chartType'
                                                                              value='air_mode'>공기청정기
                                        모드</label>
                                    <label style='padding-right: 10px'><input type='checkbox'
                                                                              name='chartType'
                                                                              value='fire_alarm'>화재
                                    ...
                                    <label style='padding-right: 10px'><input type='checkbox'
                                                                              name='chartType'
                                                                              value='water_alarm'>수위
                                        경보</label>
                                    <label style='padding-right: 10px'><input type='checkbox'
                                                                              name='chartType'
                                                                              value='dev_stat'>장비 상태</label>
                                </div>
                            </div>
