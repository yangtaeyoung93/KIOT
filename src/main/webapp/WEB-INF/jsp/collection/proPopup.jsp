...
<head>
    ...
    <script src="https://www.amcharts.com/lib/4/fonts/notosans-kr.js"></script>
    ...
    <script src="/resources/html2pdf/dist/html2pdf.bundle.js"></script>
    <script src="/resources/html2pdf/html2canvas.min.js"></script>
    <script src="/resources/html2pdf/jspdf.min.js"></script>
...
<script>
    var serialNum = '<%=request.getParameter("p_h_serialNum")%>';
    var parentSpaceName = '<%=request.getParameter("p_h_parentSpaceName")%>';
    var spaceName = '<%=request.getParameter("p_h_spaceName")%>';
    var productDt = '<%=request.getParameter("p_h_productDt")%>';
    var stationName = '<%=request.getParameter("p_h_stationName")%>';
    var standard = '<%=request.getParameter("standard")%>';
    var memberIdx = '<%=request.getParameter("p_h_memberIdx")%>';
    var deviceIdx = '<%=request.getParameter("p_h_deviceIdx")%>';
    var deviceType = '<%=request.getParameter("deviceType")%>';
</script>

<script src="/resources/share/js/collection/proPopup.js"></script>
                ...
                <div class="card">
                    <form role="form">
                        <div class="card-body">
                            ...
                            <input type="hidden" id="p_h_memberIdx"/>
                            <input type="hidden" id="p_h_deviceIdx"/>
                            <div class="row" style="border-top:3px solid #aaa; height:35px; line-height:35px;">
                                <div class="col-2" style="background-color:#e6edf9; border-bottom:1px solid #aaa;">
                                    시리얼번호
                                </div>
                                <div class="col-4" id="txtSerialNum" style="border-bottom:1px solid #aaa;"></div>
                                <div class="col-2" style="border-bottom:1px solid #aaa;"></div>
                                <div class="col-4" style="border-bottom:1px solid #aaa;"></div>
                            </div>
                            <div class="row" style="height:35px; line-height:35px;margin-top: 4px;">
                                <div class="col-2" style="border-bottom:3px solid #aaa; background-color:#e6edf9;">
                                    등록일자
                                </div>
                                <div class="col-4" id="txtProductDt" style="border-bottom:3px solid #aaa;"></div>
                                <div class="col-6" style="border-bottom:3px solid #aaa;">
									<span id="detailBtn" class="btn btn-primary ml3 mr10">
										설치정보 보기
									</span>
                                    <span id="pdfDownBtn" class="btn btn-primary ml3 mr10">
										PDF 다운로드
									</span>
                                    <span id="winDownBtn" class="btn btn-primary ml3 mr10">
										Window 다운로드
									</span>
                                </div>
                            </div>
                            <div class="form-group mt20">
                                ...
                                <input type="text" class="form-control d-inline-block" name="startDt" id="startDt"
                                       placeholder="시작일자 클릭 후 선택" style="width:150px; vertical-align: middle;"> ~
                                <input type="text" class="form-control d-inline-block mr10" name="endDt" id="endDt"
                            ...
                            <div class="form-group mt10">
                                <h5 style="display:inline-block;margin-bottom: 0.25rem; vertical-align: middle;"
                                    id="tableTitle">검색 결과</h5>
                                <table id="popTable" class="table table-bordered table-hover text-center"
