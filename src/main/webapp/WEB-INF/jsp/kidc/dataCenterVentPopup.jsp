...
<script src="/resources/share/js/datacenter/pop_vent.js"></script>
<div class="content-wrapper" style="margin-left:0px !important;">
	<section class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<h4 class="modal-title"><strong><span id="txtStationName"></span>환기청정기 설정</strong></h4>
			</div>
		</div>
		<!-- /.container-fluid -->
	</section>
	<section class="content">
		<div class="row">
			<div class="col-12">
				<div class="card">
					<div class="card-body">
						<span id="txtSpanStation" style="margin-right:10px;"></span>
						<span id="txtSpanSerial"></span>
						<table id="popTable" class="table table-bordered table-hover text-center" style="margin-top:10px;">
								<thead>
	                     		<tr>
	                     			<th class="bgGray1">시리얼번호</th>
	                     			<th class="bgGray1">AI모드</th>
	                     			<th class="bgGray1">전원</th>
		                        	<th class="bgGray1">풍량설정</th>
