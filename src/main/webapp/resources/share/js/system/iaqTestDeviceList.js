...
function viewData2(serialNum,parentSpaceName,spaceName,productDt,stationName,standard){
	...
	var act_url = "/system/device/iaq_popup";
...
function initDataTableCustom(){
	...
	var table = $('#iaqTable').DataTable({
        ...
        serverSide: false,
		ajax : {
			 "url":"/api/collection/test/list/iaq",
			 "type":"GET",
			 data : function (param) {
        ...
        columnDefs: [ 
        	...
        	},
        	{
	        	...
	        	render: function(data, type, full, meta) {
	        		...
	        		return "<font style='font-weight:bold; font-size:13px; color:"+fontColor+"'>"+cici+"</font>";
				},
        	}
        ],
	});
