...
function viewData2(serialNum,parentSpaceName,spaceName,productDt,stationName,standard){
	...
	var act_url = "/system/device/dot_popup";
...
function initDataTableCustom(){
	var table = $('#dotTable').DataTable({
        ...
        serverSide: false,
		ajax : {
			 "url":"/api/collection/test/list/dot",
			 "type":"GET",
			 data : function (param) {}
		},
        columns : [
        ...
        columnDefs: [ 
        	...
        	},
        	{
	        	...
	        	render: function(data, type, full, meta) {
	        		var lux = "";
	        		if(full.sensor == null || full.sensor.lux == null){
	        			lux = "-";
	        			fontColor = "";
	        		}else{
	        			lux = full.sensor.lux;
	        		}
	        		return "<font style='font-weight:bold; font-size:13px;'>"+lux+"</font>";
				},
        	},
        	{
	        	targets:   9, //VOCS
	        	...
	        	render: function(data, type, full, meta) {
	        		var uv = "";
	        		if(full.sensor == null || full.sensor.uv == null){
	        			uv = "-";
	        		}else{
	        			uv = full.sensor.uv;
	        		}
	        		return "<font style='font-weight:bold; font-size:13px;'>"+uv+"</font>";
				},
        	},
        	{
	        	targets:   10, //cici
