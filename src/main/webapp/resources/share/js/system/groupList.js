        ...
        columnDefs: [ 
        	{
	        	...
	        	render: function(data, type, full, meta) {
					return '<label style="width: 100%;"> <input type="checkbox" name="boardIdx" value='+full.idx +' class="chBox" data-cartNum='+full.idx+' data-groupId = '+full.groupId+'></label>';
				},
        	},
	        {
...
function goInsert(){
	location.href="/system/group/detail";
}
