...
function popDataTableDraw(apiData, rawApiData, colums) {
	...
	var table = $('#popiaqTable').DataTable({
		scrollCollapse: true,
		autoWidth: false,
		language : {
	...
	$("#popiaqTable_filter").hide();
	$($("#tableTitle")).insertBefore("#popiaqTable_length");
	$("#popiaqTable_length").css("display","inline-block");
	$("#popiaqTable_length").css("margin-left","20px");
	$("#modalDownloadBtn").insertAfter("#popiaqTable_filter");
	$("#popiaqTable_wrapper .top").first().css("border-bottom", "1px solid #E5E5E5");
	$("#popiaqTable_wrapper .top").first().css("padding-bottom", "15px");
	$("#popiaqTable_wrapper .top").first().css("margin-bottom", "20px");
